# -*- coding: utf-8 -*-
"""CSE110 Lab Assignment 2 (Loops).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TTY5AScEDq40SJLMzbdnvck9LvrelR-V
...
# sum = 0
# a = 9
# n = int(input("Enter how many time you want to continue: "))
...
for i in range(1, 11):
    ...
    if n % 2 != 0:
        num = num + n
        count = count + 1
print(f"The total of the odd numbers is {num} and their average is {num/count}")
...
while power>0:
    r = x//power
    x = x%power                      ## have taken from friend(source)
    power = power//10
...
num1 = int(input(""))
num2 = int(input(""))
for i in range(1, num1+1):  #row 
    for j in range(1, num2+1): #column
        print(j,end="")
    print()
